...
hl.animation({ leaf = "border", enabled = true, speed = 2.69, bezier = "easeOutQuint" })
...
hl.animation({ leaf = "windowsOut", enabled = true, speed = 0.74, bezier = "linear", style = "popin 87%" })
hl.animation({ leaf = "fadeIn", enabled = true, speed = 0.86, bezier = "almostLinear" })
hl.animation({ leaf = "fadeOut", enabled = true, speed = 0.73, bezier = "almostLinear" })
hl.animation({ leaf = "fade", enabled = true, speed = 1.51, bezier = "quick" })
...
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 0.69, bezier = "almostLinear" })
